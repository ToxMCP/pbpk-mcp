...
def _tool_components() -> Dict[str, Any]:
    ...
    from mcp_bridge.pbpk_tools.cancel_job import CancelJobRequest, CancelJobResponse, cancel_job
    from mcp_bridge.pbpk_tools.discover_models import DiscoverModelsRequest, DiscoverModelsResponse, discover_models
    from mcp_bridge.pbpk_tools.export_oecd_report import ExportOecdReportRequest, ExportOecdReportResponse, export_oecd_report
    from mcp_bridge.pbpk_tools.get_job_status import GetJobStatusRequest, GetJobStatusResponse, get_job_status
    from mcp_bridge.pbpk_tools.get_parameter_value import (
        GetParameterValueRequest,
        GetParameterValueResponse,
        get_parameter_value,
    )
    from mcp_bridge.pbpk_tools.get_population_results import (
        GetPopulationResultsRequest,
        GetPopulationResultsResponse,
        get_population_results,
    )
    from mcp_bridge.pbpk_tools.get_results import GetResultsRequest, GetResultsResponse, get_results
    from mcp_bridge.pbpk_tools.ingest_external_pbpk_bundle import (
        IngestExternalPbpkBundleRequest,
        IngestExternalPbpkBundleResponse,
        ingest_external_pbpk_bundle,
    )
    from mcp_bridge.pbpk_tools.list_parameters import ListParametersRequest, ListParametersResponse, list_parameters
    from mcp_bridge.pbpk_tools.load_simulation import LoadSimulationRequest, LoadSimulationResponse, load_simulation
    ...
    from mcp_bridge.pbpk_tools.run_simulation import RunSimulationRequest, RunSimulationResponse, run_simulation
    from mcp_bridge.pbpk_tools.run_verification_checks import (
    ...
    from mcp_bridge.pbpk_tools.validate_model_manifest import (
        ValidateModelManifestRequest,
        ValidateModelManifestResponse,
        validate_model_manifest,
    )
    from mcp_bridge.pbpk_tools.validate_simulation_request import (
    ...
    return {
        ...
        "RunParameterConsistencyCheckRequest": RunParameterConsistencyCheckRequest,
        "RunParameterConsistencyCheckResponse": RunParameterConsistencyCheckResponse,
        "run_parameter_consistency_check": run_parameter_consistency_check,
    ...
    *,
    ...
    return {
        ...
        "set_parameter_value": ToolDescriptor(
            ...
            dependencies=("adapter", "audit_trail", "snapshot_store"),
            roles=standard_roles("operator", "admin"),
            critical=True,
            requires_confirmation=True,
        ...
        "run_population_simulation": ToolDescriptor(
            ...
            dependencies=("adapter", "job_service", "config"),
            roles=standard_roles("operator", "admin"),
            critical=True,
            requires_confirmation=True,
        ),
        ...
        "run_parameter_consistency_check": ToolDescriptor(
            name="run_parameter_consistency_check",
            description="Run cross-parameter physiological consistency checks for a loaded simulation (e.g. organ volumes vs body weight, blood flows vs cardiac output).",
            request_model=tools["RunParameterConsistencyCheckRequest"],
            response_model=tools["RunParameterConsistencyCheckResponse"],
            handler=tools["run_parameter_consistency_check"],
            dependencies=("adapter",),
            roles=standard_roles("viewer", "operator", "admin"),
            read_only_hint=True,
        ),
